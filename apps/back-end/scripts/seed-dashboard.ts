...
const buildEscrow = (
	overrides: Partial<Prisma.EscrowCreateInput>,
): Prisma.EscrowCreateInput => ({
	id: randomUUID(),
	jobId: randomUUID(),
	payer: "0x0",
	amount: decimal("200"),
...
const buildDispute = (
	overrides: Partial<Prisma.DisputeCreateInput>,
...
const seed = async () => {
	...
	console.log("Created disputes:", [
		disputeInitiatedByMe.id,
		disputeAgainstMyJob.id,
	]);
