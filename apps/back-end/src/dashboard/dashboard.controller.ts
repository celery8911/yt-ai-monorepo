...
export class DashboardController {
  ...
  async publishedJobs(@Query() query: DashboardQueryDto) {
    return this.dashboardService.getPublishedJobs(query.address, query.page, query.limit);
  }

  @Get("published-agents")
  async publishedAgents(@Query() query: DashboardQueryDto) {
    return this.dashboardService.getPublishedAgents(query.address, query.page, query.limit);
  }

  @Get("signed-agents")
  async signedAgents(@Query() query: DashboardQueryDto) {
    return this.dashboardService.getSignedAgents(query.address, query.page, query.limit);
  }

  @Get("disputes")
  async disputes(@Query() query: DashboardQueryDto) {
    return this.dashboardService.getDisputes(query.address, query.page, query.limit);
  }
