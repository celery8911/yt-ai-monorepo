...
const createServices = () => {
  ...
  const dashboardService = new DashboardService(jobsService, agentsService, walletService, prisma);
  return { jobsService, agentsService, walletService, dashboardService };
};

test("getStats returns computed counts from in-memory data", async () => {
  const { jobsService, agentsService, dashboardService } = createServices();
