...
const CreateAgent = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    endpointUrl: "",
    tags: [] as string[],
    skillLevel: "INTERMEDIATE" as "BEGINNER" | "INTERMEDIATE" | "ADVANCED" | "EXPERT",
    ...
    currency: "USD",
    owner: "default-user", // 这里应该从用户认证系统获取
  });
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <h3 className="font-black text-sm uppercase tracking-widest">模型接口与定价</h3>
          </div>
        </CardHeader>
        <CardContent className="space-y-6">
          <Input
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Input
              ...
              onChange={(e) => handleInputChange("pricePerTask", e.target.value ? parseFloat(e.target.value) : undefined)}
            />
            <Input
              label="货币"
              placeholder="USD"
