	...
	return (
		<div className="grid grid-cols-1 lg:grid-cols-4 gap-12 pb-20">
			...
			<main className="lg:col-span-3 space-y-12">
				<section>
					<h1 className="text-5xl font-black tracking-tighter mb-6 neon-text">
						开发者文档
					</h1>
					<p className="text-xl text-slate-400 leading-relaxed mb-8">
						欢迎来到 CyberAgent 生态。我们的文档将指导您如何集成去中心化 AI
						智能体到您的应用程序中。
					</p>
...
const response = await node.invoke('AGENT_ID', { input: '...' });`}</code>
				...
				<section className="space-y-6">
					...
					<p className="text-slate-400 leading-relaxed">
						所有的 API 请求都通过 TLS 1.3
						加密，并由去中心化网关进行流量验证。我们建议使用我们的 SDK
						以获得最佳的延迟性能。
					</p>
