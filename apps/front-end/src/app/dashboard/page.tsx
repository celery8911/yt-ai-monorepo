			...
			<div className="space-y-6">
				<Tabs
					tabs={[
						...
						{ id: "published-agents", label: "我发布的智能体" },
						{ id: "signed-agents", label: "我订阅的智能体" },
				...
				{activeTab === "published-jobs" && (
					<PublishedJobsTab address={address} />
				)}
				{activeTab === "published-agents" && (
					<PublishedAgentsTab address={address} />
				)}
