...
type ChainContracts = {
	...
	readonly SignatureVerifier: `0x${string}`;
};
...
export const CONTRACTS: Record<string, ChainContracts> = {
	sepolia: {
		...
		SignatureVerifier: "0x0000000000000000000000000000000000000000", // Deploy later
	},
	arbitrumSepolia: {
		...
		SignatureVerifier: "0x0000000000000000000000000000000000000000",
	},
	baseSepolia: {
		CBT: "0x0000000000000000000000000000000000000000",
		Treasury: "0x0000000000000000000000000000000000000000",
